...
def test_create_1_simple_product():
    ...
    assert payload['name'] == db_product[0]['post_title'], f"Create product, title id does not match " \
        f"title in API. DB title: {db_product['post_title']}, API title: {payload['name']}"
